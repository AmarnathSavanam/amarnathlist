...
export const entertainmentData: EntertainmentItem[] = [
  ...
  },
  {
    ...
    description: "When alien invaders overwhelm Earth's defenses, humanity's last hope lies in an ancient mecha buried beneath the ocean.",
    category: "anime",
    genres: ["Mecha", "Sci-Fi"],
    year: 2024,
    rating: 8.5,
  ...
  },
  {
    ...
    description: "A disgraced samurai wanders feudal Japan seeking redemption for a sin he cannot remember.",
    category: "anime",
